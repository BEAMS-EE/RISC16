...
public class Bus {
  ...
  private Color colorD=Color.black,colorE=new Color(255,153,0),colorB=Color.green;//new Color(255,205,80);//new Color(85,220,68);//Color.green;//orange;
...
//    public int getData(){return data; }
 ...
 /////////////////////////////
 public String dataHex(int data){
    String temp=new String();
    temp=Integer.toHexString(data) ;
    while(temp.length()<4)  temp="0"+temp;
    return "0x"+temp;
 }
 public String dataBin(int data){
    String temp=new String();
...
/////////////////////////////
  ...
  if(couleur==Color.black)  couleur=colorE;	//couleur=Color.green;
