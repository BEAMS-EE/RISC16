...
// Change le format (via menu display)
  public void setFormat(int d){
    for(int i=0;i<reg.length;i++){
         reg[i].setFormat(d,true);
         //if(d==3) reg[i].setLg(160); else setLg(100);
    }
...
//////////////////////////////////////////////////////////////////////////////
  public void paint(Graphics g){
     ...
     //g.drawString("data 2",super.getX()+30,               super.getY()+super.getHt()-3);
     //g.drawString("data 1",super.getX()+super.getLg()-40, super.getY()+super.getHt()-3);
     g.drawString("data 2",getOutput()[1].getX()[0][0]-15,               super.getY()+super.getHt()-3);
     g.drawString("data 1",getOutput()[0].getX()[0][0]-15, super.getY()+super.getHt()-3);
     for(int i=0;i<reg.length;i++)
        reg[i].paint(g);
  }
////////////////////////////////////////////////////////////////////////////////////////////////
public void act(int clkState) {
	// TODO Auto-generated method stub
	if (clkState>0 && clkState<11) act();
